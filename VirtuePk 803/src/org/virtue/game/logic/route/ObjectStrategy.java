...
public class ObjectStrategy extends RouteStrategy {
	...
	public ObjectStrategy(RS3Object object) {
		this.x = object.getTile().getX();
		this.y = object.getTile().getY();
		this.routeType = object.getType();
		this.type = object.getType();
		this.rotation = object.getRotation();
		this.sizeX = rotation == 0 || rotation == 2 ? object.getDefinition().getSize()[0] : object.getDefinition().getSize()[1];
		this.sizeY = rotation == 0 || rotation == 2 ? object.getDefinition().getSize()[1]: object.getDefinition().getSize()[0];
		//this.accessBlockFlag = object.getDefinition().walkToData;
		//if (rotation != 0)
	...
	private int getType(RS3Object object) {
