...
import org.virtue.game.logic.content.skills.runecrafting.Resources.Talisman;
...
public class MysteriousRunes extends RS3Object {
	...
	public static enum Definition {
		...
		BODY(2457, Talisman.BODY, new Tile(2522, 4825, 0)),
		...
		DEATH(-1, Talisman.DEATH, new Tile(2207, 4836, 0)),
