...
public enum Log {
	...
	NORMAL(1, 25, 1511, 20, 4, 8, 0, 40350),//Also 40350-40357
	OAK(15, 37.5, 1521, 30, 4, 15, 15, 78118),//Also includes 78119
	WILLOW(30, 67.5, 1519, 60, 4, 51, 15, 11855),
	TEAK(35, 85, 6333, 60, 4, 51, 10, 9037),//TODO: Find respawn delays and chop times
	MAPLE(45, 100, 1517, 83, 16, 72, 10, 31057),
	//Mahogany - 9035? Teak - 9037?
	MAHOGANY(50, 125, 6332, 83, 16, 72, 10, 40350),//TODO: Find respawn delays, proper stump ID and chop times
	YEW(60, 175, 1515, 120, 17, 94, 10, 4329),//TODO: Find stump ID
	MAGIC(75, 250, 1513, 150, 21, 121, 10, 63179),//37824
	ELDER(90, 325, 29556, 150, 21, 121, 0, -1);//TODO: Find respawn delays and chop times
	...
	Log (int level, double xp, int logID, int logBaseTime, int logRandomTime, int respawnDelay, int randomLifeProbability, int stumpID) {
