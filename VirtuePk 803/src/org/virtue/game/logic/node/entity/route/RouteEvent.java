package org.virtue.game.logic.node.entity.route;
...
public class RouteEvent {
	...
	public boolean processEvent(final Player player) {
		if (!simpleCheck(player)) {
			...
			//player.getWriter().sendResetMinimapFlag();//TODO: Impmenet this method...
			return true;
		}
	...
	private boolean simpleCheck(Player player) {
		/*if (object instanceof Entity) {
			...
			return player.getTile().getPlane() == ((WorldObject) object).getPlane();
		} else if (object instanceof GroundItem) {
			return player.getTile().getPlane() == ((GroundItem) object).getLocation().getPlane();
		} else {*/
