...
import org.virtue.cache.util.apache.CBZip2OutputStream;
import org.virtue.cache.util.apache.bzip2.BZip2CompressorInputStream;
...
public final class CompressionUtils {
	...
	public static byte[] bunzip2(byte[] bytes) throws IOException {
		...
		/*
		 * byte[] bzip2 = new byte[bytes.length + 2]; bzip2[0] = 'h'; bzip2[1] =
		 * '1'; System.arraycopy(bytes, 0, bzip2, 2, bytes.length);
		 */
