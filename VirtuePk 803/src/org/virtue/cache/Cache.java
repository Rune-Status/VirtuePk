...
import org.virtue.cache.util.ByteBufferUtils;
import org.virtue.cache.util.crypto.Djb2;
...
public final class Cache implements Closeable {
	...
	public static final int[] UPDATE_INTEGERS = { 2303, 69795, 41433, 35866,
	...
	public static final int SERVER_REVISION = 803;
	...
	/**
	 * @param checksumtable The checksumtable to set
	 */
	public void setChecksumtable(ByteBuffer checksumtable) {
