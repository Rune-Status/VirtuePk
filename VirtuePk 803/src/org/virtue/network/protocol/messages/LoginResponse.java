...
public class LoginResponse {
	 ...
	 */
	public LoginResponse(int returnCode, ChannelBuffer payload, int payloadSize) {
		this(returnCode, payload, payloadSize, false);
	}
	
	public LoginResponse (int returnCode, ChannelBuffer payload, int payloadSize, boolean isVarShort) {
